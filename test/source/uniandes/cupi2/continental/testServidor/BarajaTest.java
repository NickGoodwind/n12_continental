...
/**
 * Clase usada para verificar que los m�todos de la clase Baraja est�n correctamente implementados.
 */
public class BarajaTest extends TestCase
{
    ...
    /**
     * Ruta donde se encuentra el archivo con la definici�n de las cartas.
     */
    ...
    /**
     * Escenario 2: Construye una baraja vac�a
     * 
     */
    ...
    /**
     * Escenario 3: Contruye una baraja con 7 cartas que no es v�lida para ganar
     */
    ...
    /**
     * Escenario 3: Contruye una baraja con 7 cartas que es v�lida para ganar
     */
    ...
    public void testValidar( )
    {
    	...
    	assertFalse( "No deber�a validar la victoria", condicion );
    }
    ...
    public void testValidar2( )
    {
    	...
    	assertTrue( "Error en la cantidad de cartas", baraja.darNumCartas( ) == 4 );
    	assertEquals( "No deber�a validar la victoria", true, condicion );
    }
