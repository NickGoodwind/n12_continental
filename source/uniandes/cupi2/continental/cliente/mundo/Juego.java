 ...
 * <b>inv: </b><br>
 * cartasEnJuego contiene m�ximo 7 cartas.<br>
 */
public class Juego
{
    // -----------------------------------------------------------------
     ...
     * @param representacion Representaci�n de la carta. representacion != null.
    ...
    {
        assert ( cartasEnJuego.size( ) <= 7 ) : "No puede contener m�s de siete cartas.";
    }
